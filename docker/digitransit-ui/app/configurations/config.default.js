...
const API_URL = process.env.API_URL || 'https://realtimepilot.digitransit.eu';
...
const APP_DESCRIPTION = 'Digitransit journey planning UI - REALTIME BETA';
const MQTT = process.env.MQTT || 'ws://realtimepilot.digitransit.eu';
